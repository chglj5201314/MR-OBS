...
def obs_sceneitem_group_remove_item(item: 'obs_sceneitem_t *') -> "void":
    return _obspython.obs_sceneitem_group_remove_item(item)
obs_sceneitem_group_remove_item = _obspython.obs_sceneitem_group_remove_item

def obs_sceneitem_get_group(item: 'obs_sceneitem_t *') -> "obs_sceneitem_t *":
    return _obspython.obs_sceneitem_get_group(item)
obs_sceneitem_get_group = _obspython.obs_sceneitem_get_group

def obs_sceneitem_group_from_scene(scene: 'obs_scene_t *') -> "obs_sceneitem_t *":
    return _obspython.obs_sceneitem_group_from_scene(scene)
obs_sceneitem_group_from_scene = _obspython.obs_sceneitem_group_from_scene

def obs_sceneitem_group_from_source(source: 'obs_source_t *') -> "obs_sceneitem_t *":
    return _obspython.obs_sceneitem_group_from_source(source)
obs_sceneitem_group_from_source = _obspython.obs_sceneitem_group_from_source
