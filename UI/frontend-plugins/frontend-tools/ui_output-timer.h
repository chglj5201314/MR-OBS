...
public:
    ...
    {
        OutputTimer->setWindowTitle(QApplication::translate("OutputTimer", "OutputTimer", 0));
        streamingLabel->setText(QApplication::translate("OutputTimer", "OutputTimer.Stream", 0));
        hoursLabel->setText(QApplication::translate("OutputTimer", "Hours", 0));
        minutesLabel->setText(QApplication::translate("OutputTimer", "Minutes", 0));
        secondsLabel->setText(QApplication::translate("OutputTimer", "Seconds", 0));
        outputTimerStream->setText(QApplication::translate("OutputTimer", "Start", 0));
        streamStoppingIn->setText(QApplication::translate("OutputTimer", "OutputTimer.Stream.StoppingIn", 0));
        streamTime->setText(QApplication::translate("OutputTimer", "00:00:00", 0));
        recordingLabel->setText(QApplication::translate("OutputTimer", "OutputTimer.Record", 0));
        hoursLabel_2->setText(QApplication::translate("OutputTimer", "Hours", 0));
        minutesLabel_2->setText(QApplication::translate("OutputTimer", "Minutes", 0));
        secondsLabel_2->setText(QApplication::translate("OutputTimer", "Seconds", 0));
        outputTimerRecord->setText(QApplication::translate("OutputTimer", "Start", 0));
        recordStoppingIn->setText(QApplication::translate("OutputTimer", "OutputTimer.Record.StoppingIn", 0));
        recordTime->setText(QApplication::translate("OutputTimer", "00:00:00", 0));
        autoStartStreamTimer->setText(QApplication::translate("OutputTimer", "OutputTimer.Stream.EnableEverytime", 0));
        autoStartRecordTimer->setText(QApplication::translate("OutputTimer", "OutputTimer.Record.EnableEverytime", 0));
    } // retranslateUi
