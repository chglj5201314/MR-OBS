...
public:
    ...
    {
        SceneSwitcher->setWindowTitle(QApplication::translate("SceneSwitcher", "SceneSwitcher", 0));
        label->setText(QApplication::translate("SceneSwitcher", "SceneSwitcher.OnNoMatch", 0));
        noMatchDontSwitch->setText(QApplication::translate("SceneSwitcher", "SceneSwitcher.OnNoMatch.DontSwitch", 0));
        noMatchSwitch->setText(QApplication::translate("SceneSwitcher", "SceneSwitcher.OnNoMatch.SwitchTo", 0));
        label_2->setText(QApplication::translate("SceneSwitcher", "SceneSwitcher.CheckInterval", 0));
        label_4->setText(QApplication::translate("SceneSwitcher", "SceneSwitcher.ActiveOrNotActive", 0));
        toggleStartButton->setText(QApplication::translate("SceneSwitcher", "Start", 0));
        close->setText(QApplication::translate("SceneSwitcher", "Close", 0));
    } // retranslateUi
