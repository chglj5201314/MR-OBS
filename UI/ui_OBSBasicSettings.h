...
public:
    ...
    void setupUi(QDialog *OBSBasicSettings)
    {
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, -44, 801, 741));
        ...
        groupBoxMultiview->setObjectName(QStringLiteral("groupBoxMultiview"));
        formLayoutMultiview = new QFormLayout(groupBoxMultiview);
        formLayoutMultiview->setObjectName(QStringLiteral("formLayoutMultiview"));
        ...
        multiviewMouseSwitch->setObjectName(QStringLiteral("multiviewMouseSwitch"));
        ...
        multiviewDrawNames->setObjectName(QStringLiteral("multiviewDrawNames"));
        ...
        multiviewDrawAreas->setObjectName(QStringLiteral("multiviewDrawAreas"));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 601, 640));
        ...
        audioSourceWidget->setGeometry(QRect(0, 0, 63, 16));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 803, 793));
        ...
        formLayout_27->setLabelAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        formLayout_27->setContentsMargins(-1, 2, -1, -1);
        ...
        formLayout_27->setItem(1, QFormLayout::LabelRole, horizontalSpacer_11);
        ...
        formLayout_23->setItem(1, QFormLayout::LabelRole, horizontalSpacer_7);
        ...
        formLayout_33->setObjectName(QStringLiteral("formLayout_33"));
        formLayout_33->setContentsMargins(-1, 2, -1, -1);
        disableFocusHotkeys = new QCheckBox(groupBox_17);
        disableFocusHotkeys->setObjectName(QStringLiteral("disableFocusHotkeys"));

        formLayout_33->setWidget(0, QFormLayout::FieldRole, disableFocusHotkeys);

        horizontalSpacer_14 = new QSpacerItem(170, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        formLayout_33->setItem(0, QFormLayout::LabelRole, horizontalSpacer_14);


        verticalLayout_17->addWidget(groupBox_17);
    ...
    void retranslateUi(QDialog *OBSBasicSettings)
    {
        ...
        groupBoxMultiview->setTitle(QApplication::translate("OBSBasicSettings", "Basic.Settings.General.Multiview", 0));
        multiviewMouseSwitch->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.General.Multiview.MouseSwitch", 0));
        multiviewDrawNames->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.General.Multiview.DrawSourceNames", 0));
        multiviewDrawAreas->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.General.Multiview.DrawSafeAreas", 0));
        ...
        groupBox_17->setTitle(QApplication::translate("OBSBasicSettings", "Basic.Settings.Hotkeys", 0));
        disableFocusHotkeys->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Advanced.Hotkeys.DisableHotkeysInFocus", 0));
    } // retranslateUi
